...
![alt text](figs/observed_vs_predicted_error_mean_with_interactions.png)

And this predicted error field:

![alt text](figs/predicted_error_mean_vs_ice_thickness_change_and_altimetry_range.png)

Which matches the true error field well:

![alt text](figs/gmsl_error_over_ice_change_and_altimetry_range.png)
