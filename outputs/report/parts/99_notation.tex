...
\begin{tabular}{@{}lp{10cm}@{}}
    ...
    \textbf{Symbol} & \textbf{Description} \\
    \midrule
    $\thicknesschange{i}$              & Ice thickness change field \\
    $\thicknesschange{f}$              & Firn thickness change field \\
    $\thicknesschange{odt}$            & Ocean dynamic topography thickness change field \\
    $\thicknesschange{Ice}$            & Ice thickness change (block-matrix notation) \\
    $\thicknesschange{Firn}$           & Firn thickness change (block-matrix notation) \\
...
\begin{tabular}{@{}lp{10cm}@{}}
    ...
    $\covariance{\thicknesschange{i}}$ & Covariance operator for ice thickness change \\
