...
Which maps the model space vector $\mathbf{x} = (\thicknesschangeice,\, \thicknesschangefirn,\, \odtchange)$ to the data space vector $d = (d_{\Delta SSH},\, d_{\Delta TG},\, d_{\Delta ISH})$.
