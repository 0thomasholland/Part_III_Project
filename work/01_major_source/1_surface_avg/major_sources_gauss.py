# Major sources - Gaussian framework
# Computes the GMSL estimation error for major sources (GIS, WAIS, EAIS)
# using a Gaussian measure framework, analogous to major_source_scalar.py
# but with statistical distributions instead of scalar fields.
#
...
altimetry_latitudes = np.linspace(10, 90, 100)
...
#     )
#     estimated_gmsl_op = ice_thickness_to_estimated_gmsl_operator(
#         finger_print=fp,
#         finger_print_operator=fp_op,
#         altimetry_latitude_range=latitude,
#     )
#     error_op = ice_thickness_to_gmsl_estimation_error_operator(
#         finger_print=fp,
#         finger_print_operator=fp_op,
#         altimetry_latitude_range=latitude,
#     )
...
#                 ] = _ice_measure.affine_mapping(operator=gmsl_op)
#                 estimate_measures[
#                     (source, latitude, mean, std)
#                 ] = _ice_measure.affine_mapping(operator=estimated_gmsl_op)
#                 error_measures[
#                     (source, latitude, mean, std)
#                 ] = _ice_measure.affine_mapping(operator=error_op)
...
#     error_stats[key] = (expectation_value, std_value)
...
#     expectation_value = expectation(measure)
#     std_value = np.sqrt(variance(measure))
#     true_gmsl_stats[key] = (expectation_value, std_value)
