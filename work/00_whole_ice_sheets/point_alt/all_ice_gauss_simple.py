...
error_measure: GaussianMeasure = ice_thickness_measure.affine_mapping(
    operator=ice_thickness_to_gmsl_point_estimation_error_operator(
        finger_print=fp,
        finger_print_operator=fp_op,
        altimetry_latitude_range=66.0,
...
fig, (ax1, ax2) = error_plot(
    ...
    suptitle="GMSL Estimation from Point Altimetry",
    show_bias=True,
)
plt.tight_layout()
plt.savefig("gmsl_point_estimation_error.png", dpi=300)
