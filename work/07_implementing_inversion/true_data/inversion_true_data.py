...
ice_change = IceSheetChange.global_ice(
    ...
    length_scale=0.05 * fp.model.parameters.mean_sea_floor_radius,
...
# Convert to data-space vector (EuclideanSpace: from_components is identity)
data_space = (
