...
ax1.plot(
    years, wais_means, label="WAIS Mean", color="orange"
)
ax1.fill_between(
    years,
...
ax1.plot(
    years, eais_means, label="EAIS Mean", color="green"
)
ax1.fill_between(
    years,
...
ax1.set_title(
    "Posterior GMSL Contribution Means and Uncertainties for GIS, WAIS, EAIS, using the DUACS Annual Data (1993-2020)"
)
ax1.set_ylabel("GMSL Contribution (mm)")
ax1.legend()

ax2.plot(
    years, global_means, label="Global Mean", color="red"
)
ax2.fill_between(
    years,
...
ax2.set_xlabel("Year")
ax2.set_ylabel("GMSL Contribution (mm)")
ax2.legend()
