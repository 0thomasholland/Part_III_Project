...
ice_sheets = {
    "greenland": {
        "load_func": fp.greenland_load,
        "error_col": "greenland_error",
    },
    "west_antarctic": {
...
plt.plot(
    ...
    gaussian_filter1d(
        error_output["greenland_error"], sigma=2
    ),
    label="Greenland",
)
plt.plot(
    -error_output["latitude_min"],
    gaussian_filter1d(
        error_output["west_antarctic_error"], sigma=2
    ),
...
plt.plot(
    -error_output["latitude_min"],
    gaussian_filter1d(
        error_output["east_antarctic_error"], sigma=2
    ),
...
plt.legend()
plt.savefig(
    "ice_sheets_satellite_coverage_errors.pdf", dpi=600
)
plt.show()
