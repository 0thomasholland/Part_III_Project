...
altimetry_error_length_scale = 0.04 * fp.mean_sea_floor_radius
altimetry_error_amplitude_factor = np.logspace(-2, 2, 9)
# %%
...
def get_data(
    ...
    return {
        ...
        "odt_standard_deviation_factor": odt_standard_deviation_factor,
        "altimetry_error_length_scale": altimetry_error_length_scale,
        "altimetry_error_amplitude": altimetry_error_amplitude,
        "altimetry_error_amplitude_factor": altimetry_error_amplitude_factor,
...
print(
    ...
    * len(odt_standard_deviation_factor)
    * len(altimetry_error_amplitude_factor)
    * len(altimetry_range),
)
...
results = Parallel(n_jobs=-1, verbose=4)(
    ...
    for ods in odt_standard_deviation_factor
    for aea in altimetry_error_amplitude_factor
