...
# %% plot ice thickness change sample
...
# %% set ocean dynamic topography measure
...
# %% calculate sea surface height change
...
# %% add in ocean dynamic topography
...
# %% caculate error from global mean sea level from sea surface and sea surface with ODT both at ±90 observation and ±66 deg observation using altimetry_projection(latitude_min: float = -66, latitude_max: float = 66); all fp.integrate()
