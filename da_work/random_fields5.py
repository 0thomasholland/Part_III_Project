...
mu = X.point_value_scaled_heat_kernel_gaussian_measure(
    0.1 * fp.mean_sea_floor_radius
)

f1 = fp.greenland_projection(value=0) * fp.ice_projection(
    value=0
)
f2 = fp.southern_hemisphere_projection(
    value=0
